            ...
            <tr>
              <td class="d-xl-table-cell single-line">
                <p>
                  ...
                  <span class="badge bg-{{$order->State()=='Back'?'danger':'success'}}">
                    {{$order->State()}}
                  </span>
                </p>
              </td>
              ...
              <td class="single-line">
                <p>
                  <i class="align-middle me-2 fas fa-fw fa-calendar"></i> {{$order->back_ready_at}}
                </p>
              </td>
              <td>
                @if($data['can_archive'] && $order->State() == "Back ready")
