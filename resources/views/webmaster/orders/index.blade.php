        ...
        <table class="table table-hover my-0" id="datatables-orders">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="d-xl-table-cell single-line">
                <p>
                  <i class="align-middle me-2 fas fa-fw fa-ad"></i> <a href="{{$order->campaign==null?"":route('webmaster_campaigns_show', $order->campaign)}}">
                    {{$order->campaign==null?"":$order->Campaign()->name}}</a><br>
